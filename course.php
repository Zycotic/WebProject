...
<body>
    ...
    $vidPath = $_GET['vid_path'];

    // Now you can use $vidPath as needed, for example, embedding the video:
    echo "<div class='d-flex justify-content-center m-4'>" . "<h1>Course Video</h1>" . "</div>";
    echo "<div class='d-flex justify-content-center m-4'> <video class='w-75' controls>";
    echo "<source src='$vidPath' type='video/mp4'>";
